        ...
        <tbody>
            @foreach ($utenti as $utente)
                <tr>
                    ...
                    <td class="text-right">
                        <a href="{{ route('utenti.edit', ['id' => $utente->id]) }}"
                           class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded border border-gray-300 text-gray-700 hover:bg-gray-50">
                            Modifica
                        </a>
                    </td>
                </tr>
